...
<html class="no-js" lang="">
    <head>
        ...
        <title>TattooZ - Home Three</title>
    ...
    <body>
        ...
        <div class="slider-area">
            <div class="slider-active">
                <div class="slider-items">
                    <img src="assets/images/slider/3.jpg" alt="slider" class="slider">
        ...
        <!-- about-area start -->
        <div class="about-area ptb-130 bg-1 about-area3">
            <div class="container">
                <div class="row">
        ...
        <!-- we-do-area start -->
        <div class="wedo-area bg-2 wedo-area2 wedo-area3">
            <div class="container">
                <div class="row">
